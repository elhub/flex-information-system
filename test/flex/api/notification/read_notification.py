...
) -> Optional[Union[ErrorMessage, NotificationResponse, Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, NotificationResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorMessage, NotificationResponse, Union['EmptyObject', 'ErrorMessage']]
    """
