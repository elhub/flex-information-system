...
) -> Optional[Union[Any, ErrorMessage, List["NotificationResponse"], Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["NotificationResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['NotificationResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
