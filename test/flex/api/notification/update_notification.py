...
) -> Optional[Union[Any, ErrorMessage, NotificationResponse, Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, NotificationResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        body (NotificationUpdateRequest): Request schema for update operations - Notification
            about an event happening in the system.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, NotificationResponse, Union['EmptyObject', 'ErrorMessage']]
    """
