...
) -> Union[ErrorMessage, ServiceProviderProductApplicationHistoryResponse, Union["EmptyObject", "ErrorMessage"]] | None:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProviderProductApplicationHistoryResponse, Union["EmptyObject", "ErrorMessage"]]
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProviderProductApplicationHistoryResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
