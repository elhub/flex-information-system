...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProviderProductApplicationResponse] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProviderProductApplicationResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (ListServiceProviderProductApplicationPrefer | Unset):
...
def sync(
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProviderProductApplicationResponse]
    """
