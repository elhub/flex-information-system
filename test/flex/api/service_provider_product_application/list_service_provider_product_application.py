...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, List["ServiceProviderProductApplicationResponse"], Union["EmptyObject", "ErrorMessage"]]
]:
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, ErrorMessage, List['ServiceProviderProductApplicationResponse'], Union['EmptyObject', 'ErrorMessage']]]
    """
