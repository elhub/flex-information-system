...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupProductApplicationHistoryResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProvidingGroupProductApplicationHistoryResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
