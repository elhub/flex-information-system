...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListNoticePrefer] = UNSET,
) -> Dict[str, Any]:
...
) -> Optional[Union[Any, ErrorMessage, List["NoticeResponse"], Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["NoticeResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListNoticePrefer]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['NoticeResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
