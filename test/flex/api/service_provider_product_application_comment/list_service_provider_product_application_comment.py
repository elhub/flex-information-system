...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListServiceProviderProductApplicationCommentPrefer] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        Any,
        ErrorMessage,
        List["ServiceProviderProductApplicationCommentResponse"],
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListServiceProviderProductApplicationCommentPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, List['ServiceProviderProductApplicationCommentResponse'], Union['EmptyObject', 'ErrorMessage']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['ServiceProviderProductApplicationCommentResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
