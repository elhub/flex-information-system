...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProviderProductApplicationCommentHistoryResponse, Union["EmptyObject", "ErrorMessage"]]
    | None
):
    if response.status_code == 200:
        response_200 = ServiceProviderProductApplicationCommentHistoryResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProviderProductApplicationCommentHistoryResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
