...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/service_provider_product_application_comment_history/{id}",
    }
...
) -> EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductApplicationCommentHistory | None:
    if response.status_code == 200:
        response_200 = ServiceProviderProductApplicationCommentHistory.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductApplicationCommentHistory]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductApplicationCommentHistory
    """
