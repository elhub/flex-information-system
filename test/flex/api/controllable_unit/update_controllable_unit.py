...
from ...models.controllable_unit_update_request import ControllableUnitUpdateRequest
...
) -> Optional[Union[Any, ControllableUnitResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ControllableUnitResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ControllableUnitResponse, ErrorMessage, Union['EmptyObject', 'ErrorMessage']]
    """
