...
) -> Any | ControllableUnit | EmptyObject | ErrorMessage | ErrorMessage | None:
    if response.status_code == 200:
        response_200 = ControllableUnit.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ControllableUnit | EmptyObject | ErrorMessage | ErrorMessage]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | ControllableUnit | EmptyObject | ErrorMessage | ErrorMessage
    """
