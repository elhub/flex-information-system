...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListControllableUnitHistoryPrefer] = UNSET,
) -> Dict[str, Any]:
...
) -> Optional[Union[Any, ErrorMessage, List["ControllableUnitHistoryResponse"], Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["ControllableUnitHistoryResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListControllableUnitHistoryPrefer]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['ControllableUnitHistoryResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
