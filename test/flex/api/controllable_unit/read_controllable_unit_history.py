...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/controllable_unit_history/{id}",
    }
...
) -> Optional[Union[ControllableUnitHistoryResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = ControllableUnitHistoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ControllableUnitHistoryResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ControllableUnitHistoryResponse, ErrorMessage, Union['EmptyObject', 'ErrorMessage']]
    """
