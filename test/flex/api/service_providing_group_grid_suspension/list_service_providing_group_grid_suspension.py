...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListServiceProvidingGroupGridSuspensionPrefer] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, List["ServiceProvidingGroupGridSuspensionResponse"], Union["EmptyObject", "ErrorMessage"]]
]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListServiceProvidingGroupGridSuspensionPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, List['ServiceProvidingGroupGridSuspensionResponse'], Union['EmptyObject', 'ErrorMessage']]]
    """
