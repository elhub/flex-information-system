...
) -> Optional[Union[ErrorMessage, ServiceProvidingGroupHistoryResponse, Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupHistoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, ServiceProvidingGroupHistoryResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorMessage, ServiceProvidingGroupHistoryResponse, Union['EmptyObject', 'ErrorMessage']]
    """
