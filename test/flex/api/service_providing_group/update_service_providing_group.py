...
from ...models.service_providing_group_update_request import ServiceProvidingGroupUpdateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "patch",
        "url": f"/service_providing_group/{id}",
    }
...
) -> Optional[Union[Any, ErrorMessage, ServiceProvidingGroupResponse, Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, ServiceProvidingGroupResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, ServiceProvidingGroupResponse, Union['EmptyObject', 'ErrorMessage']]
    """
