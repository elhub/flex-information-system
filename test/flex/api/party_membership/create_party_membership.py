...
) -> Optional[Union[ErrorMessage, PartyMembershipResponse, Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 201:
        response_201 = PartyMembershipResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, PartyMembershipResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorMessage, PartyMembershipResponse, Union['EmptyObject', 'ErrorMessage']]
    """
