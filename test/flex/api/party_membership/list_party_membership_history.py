...
def _get_kwargs(
    *,
    ...
    party_membership_id: Union[Unset, str] = UNSET,
    range_: Union[Unset, str] = UNSET,
    range_unit: Union[Unset, str] = UNSET,
    prefer: Union[Unset, ListPartyMembershipHistoryPrefer] = UNSET,
) -> Dict[str, Any]:
...
) -> Optional[Union[Any, ErrorMessage, List["PartyMembershipHistoryResponse"], Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["PartyMembershipHistoryResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        party_membership_id (Union[Unset, str]):
        range_ (Union[Unset, str]):
        range_unit (Union[Unset, str]):
        prefer (Union[Unset, ListPartyMembershipHistoryPrefer]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['PartyMembershipHistoryResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
