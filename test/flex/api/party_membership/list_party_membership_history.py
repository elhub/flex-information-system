...
) -> Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["PartyMembershipHistoryResponse"]] | None:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["PartyMembershipHistoryResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['PartyMembershipHistoryResponse']]
    """
