...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/party_membership_history/{id}",
    }
...
) -> Optional[Union[ErrorMessage, PartyMembershipHistoryResponse, Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = PartyMembershipHistoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, PartyMembershipHistoryResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorMessage, PartyMembershipHistoryResponse, Union['EmptyObject', 'ErrorMessage']]
    """
