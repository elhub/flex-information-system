...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | list[PartyMembershipResponse] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmptyObject | ErrorMessage | ErrorMessage | list[PartyMembershipResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (ListPartyMembershipPrefer | Unset):
...
def sync(
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | list[PartyMembershipResponse]
    """
