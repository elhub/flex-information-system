    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = ControllableUnitSuspensionCommentResponse.from_dict(response_206_item_data)
...
def sync_detailed(
    *,
    ...
    """List Controllable Unit Suspension Comment
     ...
     List [Controllable Unit Suspension Comment](https://elhub.github.io/flex-information-
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | list[ControllableUnitSuspensionCommentResponse]
    """
