...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListControllableUnitSuspensionCommentPrefer] = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["ControllableUnitSuspensionCommentResponse"]]
    | None
):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListControllableUnitSuspensionCommentPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ControllableUnitSuspensionCommentResponse']]]
    """
