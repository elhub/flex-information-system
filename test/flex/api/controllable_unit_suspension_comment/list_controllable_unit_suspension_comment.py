    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> EmptyObject | ErrorMessage | ErrorMessage | list[ControllableUnitSuspensionComment] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ControllableUnitSuspensionComment.from_dict(response_200_item_data)
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = ControllableUnitSuspensionComment.from_dict(response_206_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | list[ControllableUnitSuspensionComment]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | list[ControllableUnitSuspensionComment]
    """
