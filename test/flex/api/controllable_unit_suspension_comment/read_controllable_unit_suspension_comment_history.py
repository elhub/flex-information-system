...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/controllable_unit_suspension_comment_history/{id}",
    }
...
) -> Union[ControllableUnitSuspensionCommentHistoryResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]] | None:
    if response.status_code == 200:
        response_200 = ControllableUnitSuspensionCommentHistoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ControllableUnitSuspensionCommentHistoryResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ControllableUnitSuspensionCommentHistoryResponse, ErrorMessage, Union['EmptyObject', 'ErrorMessage']]]
    """
