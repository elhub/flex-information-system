...
) -> ControllableUnitSuspensionCommentHistory | EmptyObject | ErrorMessage | ErrorMessage | None:
    if response.status_code == 200:
        response_200 = ControllableUnitSuspensionCommentHistory.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ControllableUnitSuspensionCommentHistory | EmptyObject | ErrorMessage | ErrorMessage]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ControllableUnitSuspensionCommentHistory | EmptyObject | ErrorMessage | ErrorMessage
    """
