...
) -> Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["ProductTypeResponse"]] | None:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["ProductTypeResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ProductTypeResponse']]
    """
