...
from ...models.list_product_type_prefer import ListProductTypePrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListProductTypePrefer] = UNSET,
) -> Dict[str, Any]:
...
) -> Optional[Union[Any, ErrorMessage, List["ProductTypeResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ProductTypeResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["ProductTypeResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListProductTypePrefer]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['ProductTypeResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
