...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupGridPrequalificationCommentHistoryResponse]]
    """
...
def sync(
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupGridPrequalificationCommentHistoryResponse]
    """
