...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "patch",
        "url": f"/system_operator_product_type/{id}",
    }
...
) -> Optional[Union[Any, ErrorMessage, SystemOperatorProductTypeResponse, Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, SystemOperatorProductTypeResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, SystemOperatorProductTypeResponse, Union['EmptyObject', 'ErrorMessage']]
    """
