...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, List["SystemOperatorProductTypeResponse"], Union["EmptyObject", "ErrorMessage"]]
]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = SystemOperatorProductTypeResponse.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, ErrorMessage, List['SystemOperatorProductTypeResponse'], Union['EmptyObject', 'ErrorMessage']]]
    """
