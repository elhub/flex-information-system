...
) -> Optional[Union[ErrorMessage, SystemOperatorProductTypeHistoryResponse, Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, SystemOperatorProductTypeHistoryResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorMessage, SystemOperatorProductTypeHistoryResponse, Union['EmptyObject', 'ErrorMessage']]
    """
