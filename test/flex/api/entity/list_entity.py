...
from ...models.list_entity_prefer import ListEntityPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListEntityPrefer] = UNSET,
) -> Dict[str, Any]:
...
) -> Optional[Union[Any, ErrorMessage, List["EntityResponse"], Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["EntityResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListEntityPrefer]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['EntityResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
