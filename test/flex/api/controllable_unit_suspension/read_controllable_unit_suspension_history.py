...
) -> Union[ControllableUnitSuspensionHistoryResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]] | None:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ControllableUnitSuspensionHistoryResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ControllableUnitSuspensionHistoryResponse, ErrorMessage, Union['EmptyObject', 'ErrorMessage']]
    """
