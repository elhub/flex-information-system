...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListControllableUnitSuspensionHistoryPrefer] = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["ControllableUnitSuspensionHistoryResponse"]]
    | None
):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListControllableUnitSuspensionHistoryPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ControllableUnitSuspensionHistoryResponse']]]
    """
