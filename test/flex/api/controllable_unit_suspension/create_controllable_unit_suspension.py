...
from ...models.controllable_unit_suspension_create_request import ControllableUnitSuspensionCreateRequest
...
) -> Union[ControllableUnitSuspensionResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]] | None:
    if response.status_code == 201:
        response_201 = ControllableUnitSuspensionResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ControllableUnitSuspensionResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ControllableUnitSuspensionResponse, ErrorMessage, Union['EmptyObject', 'ErrorMessage']]
    """
