...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListControllableUnitSuspensionPrefer] = UNSET,
) -> dict[str, Any]:
...
) -> Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["ControllableUnitSuspensionResponse"]] | None:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["ControllableUnitSuspensionResponse"]]
]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListControllableUnitSuspensionPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ControllableUnitSuspensionResponse']]]
    """
