...
from ...models.list_service_providing_group_product_suspension_comment_prefer import (
...
def _get_kwargs(
    *,
    ...
    service_providing_group_product_suspension_id: Union[Unset, str] = UNSET,
    ...
    prefer: Union[Unset, ListServiceProvidingGroupProductSuspensionCommentPrefer] = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        ...
        list["ServiceProvidingGroupProductSuspensionCommentResponse"],
    ]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ServiceProvidingGroupProductSuspensionCommentResponse.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        id (Union[Unset, str]):
        service_providing_group_product_suspension_id (Union[Unset, str]):
        ...
        prefer (Union[Unset, ListServiceProvidingGroupProductSuspensionCommentPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ServiceProvidingGroupProductSuspensionCommentResponse']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ServiceProvidingGroupProductSuspensionCommentResponse']]
    """
