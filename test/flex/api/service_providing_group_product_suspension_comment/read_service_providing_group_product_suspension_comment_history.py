...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/service_providing_group_product_suspension_comment_history/{id}",
    }
...
) -> EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductSuspensionCommentHistory | None:
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupProductSuspensionCommentHistory.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductSuspensionCommentHistory]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductSuspensionCommentHistory
    """
