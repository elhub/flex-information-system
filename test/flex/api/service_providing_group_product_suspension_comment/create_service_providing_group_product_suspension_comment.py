...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProvidingGroupProductSuspensionCommentResponse, Union["EmptyObject", "ErrorMessage"]]
    | None
):
    if response.status_code == 201:
        response_201 = ServiceProvidingGroupProductSuspensionCommentResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProvidingGroupProductSuspensionCommentResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
