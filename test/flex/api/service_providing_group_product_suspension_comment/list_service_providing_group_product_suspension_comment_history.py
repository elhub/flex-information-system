...
def _get_kwargs(
    *,
    ...
    service_providing_group_product_suspension_comment_id: str | Unset = UNSET,
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupProductSuspensionCommentHistoryResponse]
]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        offset (str | Unset):
        limit (str | Unset):
        service_providing_group_product_suspension_comment_id (str | Unset):
        range_ (str | Unset):
        range_unit (str | Unset):
        prefer (ListServiceProvidingGroupProductSuspensionCommentHistoryPrefer | Unset):
    ...
    Returns:
        Response[Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupProductSuspensionCommentHistoryResponse]]
    """
