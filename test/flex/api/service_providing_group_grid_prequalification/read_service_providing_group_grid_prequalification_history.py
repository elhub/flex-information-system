...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProvidingGroupGridPrequalificationHistoryResponse, Union["EmptyObject", "ErrorMessage"]]
]:
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupGridPrequalificationHistoryResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProvidingGroupGridPrequalificationHistoryResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
