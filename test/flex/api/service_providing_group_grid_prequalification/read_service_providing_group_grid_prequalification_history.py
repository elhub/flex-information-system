...
) -> EmptyObject | ErrorMessage | ErrorMessage | GridPrequalificationForServiceProvidingGroupHistoryResponse | None:
    if response.status_code == 200:
        response_200 = GridPrequalificationForServiceProvidingGroupHistoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | GridPrequalificationForServiceProvidingGroupHistoryResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | GridPrequalificationForServiceProvidingGroupHistoryResponse
    """
