...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupGridPrequalification | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupGridPrequalification]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupGridPrequalification
    """
