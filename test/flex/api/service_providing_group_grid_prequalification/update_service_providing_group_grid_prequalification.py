...
from ...models.service_providing_group_grid_prequalification_update_request import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/service_providing_group_grid_prequalification/{id}",
    }
...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | GridPrequalificationForServiceProvidingGroupResponse | None:
    if response.status_code == 200:
        response_200 = GridPrequalificationForServiceProvidingGroupResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmptyObject | ErrorMessage | ErrorMessage | GridPrequalificationForServiceProvidingGroupResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | GridPrequalificationForServiceProvidingGroupResponse
    """
