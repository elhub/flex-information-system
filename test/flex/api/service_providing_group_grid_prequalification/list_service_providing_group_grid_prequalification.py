...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupGridPrequalificationResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ServiceProvidingGroupGridPrequalificationResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupGridPrequalificationResponse]
]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupGridPrequalificationResponse]]
    """
