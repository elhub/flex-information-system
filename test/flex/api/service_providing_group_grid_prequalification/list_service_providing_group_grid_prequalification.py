...
from ...models.grid_prequalification_for_service_providing_group_response import (
    GridPrequalificationForServiceProvidingGroupResponse,
)
from ...models.list_service_providing_group_grid_prequalification_prefer import (
...
def _get_kwargs(
    *,
    ...
    prefer: ListServiceProvidingGroupGridPrequalificationPrefer | Unset = UNSET,
) -> dict[str, Any]:
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> EmptyObject | ErrorMessage | ErrorMessage | list[GridPrequalificationForServiceProvidingGroupResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = GridPrequalificationForServiceProvidingGroupResponse.from_dict(response_200_item_data)
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = GridPrequalificationForServiceProvidingGroupResponse.from_dict(response_206_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | list[GridPrequalificationForServiceProvidingGroupResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (ListServiceProvidingGroupGridPrequalificationPrefer | Unset):
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | list[GridPrequalificationForServiceProvidingGroupResponse]
    """
