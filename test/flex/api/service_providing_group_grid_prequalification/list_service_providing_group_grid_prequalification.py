...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ServiceProvidingGroupGridPrequalificationResponse']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ServiceProvidingGroupGridPrequalificationResponse']]
    """
