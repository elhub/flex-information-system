...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListServiceProvidingGroupGridPrequalificationPrefer] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        Any,
        ErrorMessage,
        List["ServiceProvidingGroupGridPrequalificationResponse"],
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListServiceProvidingGroupGridPrequalificationPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, List['ServiceProvidingGroupGridPrequalificationResponse'], Union['EmptyObject', 'ErrorMessage']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['ServiceProvidingGroupGridPrequalificationResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
