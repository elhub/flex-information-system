...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, EntityClientResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, EntityClientResponse, ErrorMessage, Union['EmptyObject', 'ErrorMessage']]
    """
