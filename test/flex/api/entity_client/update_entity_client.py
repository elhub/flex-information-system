...
) -> Any | EmptyObject | ErrorMessage | EntityClient | ErrorMessage | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmptyObject | ErrorMessage | EntityClient | ErrorMessage]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | EntityClient | ErrorMessage
    """
