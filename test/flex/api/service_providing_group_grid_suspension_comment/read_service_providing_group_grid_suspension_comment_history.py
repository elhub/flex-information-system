...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProvidingGroupGridSuspensionCommentHistoryResponse, Union["EmptyObject", "ErrorMessage"]]
    | None
):
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProvidingGroupGridSuspensionCommentHistoryResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
