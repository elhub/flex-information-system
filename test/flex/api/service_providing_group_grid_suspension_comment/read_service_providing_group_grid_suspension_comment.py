...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProvidingGroupGridSuspensionCommentResponse, Union["EmptyObject", "ErrorMessage"]] | None
):
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupGridSuspensionCommentResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProvidingGroupGridSuspensionCommentResponse, Union["EmptyObject", "ErrorMessage"]]
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProvidingGroupGridSuspensionCommentResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
