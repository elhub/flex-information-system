...
from ...models.list_service_providing_group_grid_suspension_comment_prefer import (
...
def _get_kwargs(
    *,
    ...
    service_providing_group_grid_suspension_id: Union[Unset, str] = UNSET,
    ...
    prefer: Union[Unset, ListServiceProvidingGroupGridSuspensionCommentPrefer] = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        ...
        list["ServiceProvidingGroupGridSuspensionCommentResponse"],
    ]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ServiceProvidingGroupGridSuspensionCommentResponse.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        id (Union[Unset, str]):
        service_providing_group_grid_suspension_id (Union[Unset, str]):
        ...
        prefer (Union[Unset, ListServiceProvidingGroupGridSuspensionCommentPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ServiceProvidingGroupGridSuspensionCommentResponse']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ServiceProvidingGroupGridSuspensionCommentResponse']]
    """
