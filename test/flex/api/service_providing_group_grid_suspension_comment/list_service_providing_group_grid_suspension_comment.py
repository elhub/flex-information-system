...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupGridSuspensionCommentResponse] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupGridSuspensionCommentResponse]
]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Any | EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupGridSuspensionCommentResponse]]
    """
