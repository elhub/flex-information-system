...
from ...models.create_service_providing_group_product_application_attachment_body import (
...
) -> EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductApplicationAttachmentResponse | None:
    if response.status_code == 201:
        response_201 = ServiceProvidingGroupProductApplicationAttachmentResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductApplicationAttachmentResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Create Service Providing Group Product Application Attachment
     ...
     Create [Service Providing Group Product Application Attachment](https://elhub.github.io/flex-
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductApplicationAttachmentResponse
    """
