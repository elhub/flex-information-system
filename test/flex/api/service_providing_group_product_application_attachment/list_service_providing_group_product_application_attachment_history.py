...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | ErrorMessage
    | ErrorMessage
    | list[ServiceProvidingGroupProductApplicationAttachmentHistoryResponse]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ServiceProvidingGroupProductApplicationAttachmentHistoryResponse.from_dict(
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = ServiceProvidingGroupProductApplicationAttachmentHistoryResponse.from_dict(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupProductApplicationAttachmentHistoryResponse]]
    """
