...
def _get_kwargs(
    *,
    id: str | Unset = UNSET,
    service_providing_group_product_application_id: str,
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupProductApplicationAttachmentResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ServiceProvidingGroupProductApplicationAttachmentResponse.from_dict(
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = ServiceProvidingGroupProductApplicationAttachmentResponse.from_dict(
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupProductApplicationAttachmentResponse]
]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List Service Providing Group Product Application Attachment
     ...
     List [Service Providing Group Product Application Attachment](https://elhub.github.io/flex-
    ...
    Returns:
        Response[EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProvidingGroupProductApplicationAttachmentResponse]]
    """
