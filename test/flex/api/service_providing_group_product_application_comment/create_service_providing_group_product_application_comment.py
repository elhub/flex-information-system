...
from ...models.service_providing_group_product_application_comment_create_request import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ServiceProvidingGroupProductApplicationCommentResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductApplicationCommentResponse
    """
