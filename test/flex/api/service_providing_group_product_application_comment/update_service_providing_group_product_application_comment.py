...
from ...models.service_providing_group_product_application_comment_update_request import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupProductApplicationCommentResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductApplicationCommentResponse
    """
