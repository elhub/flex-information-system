...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/accounting_point_balance_responsible_party/{id}",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[AccountingPointBalanceResponsiblePartyResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]
]:
    if response.status_code == 200:
        response_200 = AccountingPointBalanceResponsiblePartyResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Read Accounting Point Balance Responsible Party
    ...
    Returns:
        Response[Union[AccountingPointBalanceResponsiblePartyResponse, ErrorMessage, Union['EmptyObject', 'ErrorMessage']]]
    """
