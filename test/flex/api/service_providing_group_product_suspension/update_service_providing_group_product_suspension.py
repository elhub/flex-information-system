...
from ...models.service_providing_group_product_suspension_update_request import (
...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductSuspension | None:
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupProductSuspension.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductSuspension]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupProductSuspension
    """
