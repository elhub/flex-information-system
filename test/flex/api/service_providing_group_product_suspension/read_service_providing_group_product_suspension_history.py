...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProvidingGroupProductSuspensionHistoryResponse, Union["EmptyObject", "ErrorMessage"]]
    | None
):
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProvidingGroupProductSuspensionHistoryResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
