...
) -> AccountingPoint | EmptyObject | ErrorMessage | ErrorMessage | None:
    if response.status_code == 200:
        response_200 = AccountingPoint.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AccountingPoint | EmptyObject | ErrorMessage | ErrorMessage]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AccountingPoint | EmptyObject | ErrorMessage | ErrorMessage
    """
