...
from ...models.list_accounting_point_metering_grid_area_prefer import ListAccountingPointMeteringGridAreaPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: ListAccountingPointMeteringGridAreaPrefer | Unset = UNSET,
) -> dict[str, Any]:
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = AccountingPointMeteringGridAreaResponse.from_dict(response_200_item_data)
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = AccountingPointMeteringGridAreaResponse.from_dict(response_206_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (ListAccountingPointMeteringGridAreaPrefer | Unset):
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | list[AccountingPointMeteringGridAreaResponse]
    """
