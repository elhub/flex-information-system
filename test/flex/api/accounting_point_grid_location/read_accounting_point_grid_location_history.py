...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AccountingPointGridLocationHistoryResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        AccountingPointGridLocationHistoryResponse | EmptyObject | ErrorMessage | ErrorMessage
    """
