    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = AccountingPointGridLocationHistoryResponse.from_dict(response_200_item_data)
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = AccountingPointGridLocationHistoryResponse.from_dict(response_206_item_data)
...
def sync_detailed(
    *,
    ...
    """List Accounting Point Grid Location - history
     ...
     List [Accounting Point Grid Location - history](https://elhub.github.io/flex-information-
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | list[AccountingPointGridLocationHistoryResponse]
    """
