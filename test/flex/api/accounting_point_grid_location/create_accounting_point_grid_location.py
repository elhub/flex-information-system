...
from ...models.accounting_point_grid_location_create_request import AccountingPointGridLocationCreateRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = AccountingPointGridLocationResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        AccountingPointGridLocationResponse | EmptyObject | ErrorMessage | ErrorMessage
    """
