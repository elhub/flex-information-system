...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListIdentityPrefer] = UNSET,
) -> Dict[str, Any]:
...
) -> Optional[Union[Any, ErrorMessage, List["IdentityResponse"], Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["IdentityResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListIdentityPrefer]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['IdentityResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
