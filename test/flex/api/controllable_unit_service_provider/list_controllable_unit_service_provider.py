...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListControllableUnitServiceProviderPrefer] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, List["ControllableUnitServiceProviderResponse"], Union["EmptyObject", "ErrorMessage"]]
]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListControllableUnitServiceProviderPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, List['ControllableUnitServiceProviderResponse'], Union['EmptyObject', 'ErrorMessage']]]
    """
