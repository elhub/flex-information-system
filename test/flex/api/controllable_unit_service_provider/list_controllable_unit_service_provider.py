...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["ControllableUnitServiceProviderResponse"]]
    | None
):
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ControllableUnitServiceProviderResponse']]]
    """
