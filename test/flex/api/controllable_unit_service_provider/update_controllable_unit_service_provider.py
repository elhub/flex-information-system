...
) -> Optional[Union[Any, ControllableUnitServiceProviderResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ControllableUnitServiceProviderResponse, ErrorMessage, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ControllableUnitServiceProviderResponse, ErrorMessage, Union['EmptyObject', 'ErrorMessage']]
    """
