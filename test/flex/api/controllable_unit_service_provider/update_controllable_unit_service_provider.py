...
from ...models.controllable_unit_service_provider_update_request import ControllableUnitServiceProviderUpdateRequest
...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | RelationBetweenControllableUnitAndServiceProviderResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Any | EmptyObject | ErrorMessage | ErrorMessage | RelationBetweenControllableUnitAndServiceProviderResponse
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | EmptyObject | ErrorMessage | ErrorMessage | RelationBetweenControllableUnitAndServiceProviderResponse]
    """
