...
) -> Union[ErrorMessage, ServiceProviderProductSuspensionHistoryResponse, Union["EmptyObject", "ErrorMessage"]] | None:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProviderProductSuspensionHistoryResponse, Union["EmptyObject", "ErrorMessage"]]
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProviderProductSuspensionHistoryResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
