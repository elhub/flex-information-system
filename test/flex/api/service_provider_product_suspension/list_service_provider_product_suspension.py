...
from ...models.list_service_provider_product_suspension_prefer import ListServiceProviderProductSuspensionPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: ListServiceProviderProductSuspensionPrefer | Unset = UNSET,
) -> dict[str, Any]:
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProviderProductSuspension] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ServiceProviderProductSuspension.from_dict(response_200_item_data)
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = ServiceProviderProductSuspension.from_dict(response_206_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProviderProductSuspension]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (ListServiceProviderProductSuspensionPrefer | Unset):
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | list[ServiceProviderProductSuspension]
    """
