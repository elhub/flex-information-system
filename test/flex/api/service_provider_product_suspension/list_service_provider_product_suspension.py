...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListServiceProviderProductSuspensionPrefer] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, List["ServiceProviderProductSuspensionResponse"], Union["EmptyObject", "ErrorMessage"]]
]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListServiceProviderProductSuspensionPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, List['ServiceProviderProductSuspensionResponse'], Union['EmptyObject', 'ErrorMessage']]]
    """
