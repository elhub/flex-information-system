...
from ...models.list_service_provider_product_suspension_history_prefer import (
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListServiceProviderProductSuspensionHistoryPrefer] = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        Any, ErrorMessage, Union["EmptyObject", "ErrorMessage"], list["ServiceProviderProductSuspensionHistoryResponse"]
    ]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ServiceProviderProductSuspensionHistoryResponse.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListServiceProviderProductSuspensionHistoryPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ServiceProviderProductSuspensionHistoryResponse']]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, Union['EmptyObject', 'ErrorMessage'], list['ServiceProviderProductSuspensionHistoryResponse']]
    """
