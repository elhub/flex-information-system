...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductSuspension | None:
    if response.status_code == 200:
        response_200 = ServiceProviderProductSuspension.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductSuspension]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductSuspension
    """
