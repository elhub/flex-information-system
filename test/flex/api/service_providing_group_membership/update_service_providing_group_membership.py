...
) -> Optional[Union[Any, ErrorMessage, ServiceProvidingGroupMembershipResponse, Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupMembershipResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, ServiceProvidingGroupMembershipResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, ServiceProvidingGroupMembershipResponse, Union['EmptyObject', 'ErrorMessage']]
    """
