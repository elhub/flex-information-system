...
from ...models.service_providing_group_membership_update_request import ServiceProvidingGroupMembershipUpdateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/service_providing_group_membership/{id}",
    }
...
) -> Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupMembership | None:
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupMembership.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupMembership]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupMembership
    """
