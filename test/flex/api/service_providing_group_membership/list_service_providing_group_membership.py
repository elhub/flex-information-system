...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListServiceProvidingGroupMembershipPrefer] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, List["ServiceProvidingGroupMembershipResponse"], Union["EmptyObject", "ErrorMessage"]]
]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListServiceProvidingGroupMembershipPrefer]):
    ...
    Returns:
        Response[Union[Any, ErrorMessage, List['ServiceProvidingGroupMembershipResponse'], Union['EmptyObject', 'ErrorMessage']]]
    """
