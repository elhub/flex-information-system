...
) -> EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupMembershipHistory | None:
    if response.status_code == 200:
        response_200 = ServiceProvidingGroupMembershipHistory.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupMembershipHistory]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | ServiceProvidingGroupMembershipHistory
    """
