...
) -> Union[ErrorMessage, ServiceProvidingGroupMembershipResponse, Union["EmptyObject", "ErrorMessage"]] | None:
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorMessage, ServiceProvidingGroupMembershipResponse, Union['EmptyObject', 'ErrorMessage']]
    """
