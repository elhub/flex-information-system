...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListEventPrefer] = UNSET,
) -> Dict[str, Any]:
...
) -> Optional[Union[Any, ErrorMessage, List["EventResponse"], Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["EventResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListEventPrefer]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['EventResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
