...
) -> Optional[Union[Any, ErrorMessage, TechnicalResourceResponse, Union["EmptyObject", "ErrorMessage"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, TechnicalResourceResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (TechnicalResourceUpdateRequest): Request schema for update operations - Technical
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, TechnicalResourceResponse, Union['EmptyObject', 'ErrorMessage']]
    """
