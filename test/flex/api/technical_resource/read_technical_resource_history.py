...
) -> EmptyObject | ErrorMessage | ErrorMessage | TechnicalResourceHistory | None:
    if response.status_code == 200:
        response_200 = TechnicalResourceHistory.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | TechnicalResourceHistory]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | TechnicalResourceHistory
    """
