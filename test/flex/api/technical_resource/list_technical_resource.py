...
from ...models.list_technical_resource_prefer import ListTechnicalResourcePrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, ListTechnicalResourcePrefer] = UNSET,
) -> Dict[str, Any]:
...
) -> Optional[Union[Any, ErrorMessage, List["TechnicalResourceResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = TechnicalResourceResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["TechnicalResourceResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, ListTechnicalResourcePrefer]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['TechnicalResourceResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
