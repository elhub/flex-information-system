    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = TechnicalResourceHistoryResponse.from_dict(response_206_item_data)
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | list[TechnicalResourceHistoryResponse]
    """
