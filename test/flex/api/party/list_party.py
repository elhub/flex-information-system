...
from ...models.list_party_prefer import ListPartyPrefer
...
) -> Optional[Union[Any, ErrorMessage, List["PartyResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PartyResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorMessage, List["PartyResponse"], Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorMessage, List['PartyResponse'], Union['EmptyObject', 'ErrorMessage']]
    """
