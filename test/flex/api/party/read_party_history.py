...
) -> EmptyObject | ErrorMessage | ErrorMessage | PartyHistory | None:
    if response.status_code == 200:
        response_200 = PartyHistory.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | PartyHistory]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | PartyHistory
    """
