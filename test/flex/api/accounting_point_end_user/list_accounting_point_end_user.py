...
from ...models.list_accounting_point_end_user_prefer import ListAccountingPointEndUserPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: ListAccountingPointEndUserPrefer | Unset = UNSET,
) -> dict[str, Any]:
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = AccountingPointEndUserResponse.from_dict(response_200_item_data)
    ...
    if response.status_code == 206:
        ...
        for response_206_item_data in _response_206:
            response_206_item = AccountingPointEndUserResponse.from_dict(response_206_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (ListAccountingPointEndUserPrefer | Unset):
...
def sync(
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | list[AccountingPointEndUserResponse]
    """
