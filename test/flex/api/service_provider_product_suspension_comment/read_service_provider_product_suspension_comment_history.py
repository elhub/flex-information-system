...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/service_provider_product_suspension_comment_history/{id}".format(
...
) -> EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductSuspensionCommentHistoryResponse | None:
    if response.status_code == 200:
        response_200 = ServiceProviderProductSuspensionCommentHistoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductSuspensionCommentHistoryResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Read Service Provider Product Suspension Comment - history
     ...
     Read [Service Provider Product Suspension Comment - history](https://elhub.github.io/flex-
...
def sync(
    ...
    *,
    ...
    Returns:
        EmptyObject | ErrorMessage | ErrorMessage | ServiceProviderProductSuspensionCommentHistoryResponse
    """
