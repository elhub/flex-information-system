...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[ErrorMessage, ServiceProviderProductSuspensionCommentHistoryResponse, Union["EmptyObject", "ErrorMessage"]]
    | None
):
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ErrorMessage, ServiceProviderProductSuspensionCommentHistoryResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
