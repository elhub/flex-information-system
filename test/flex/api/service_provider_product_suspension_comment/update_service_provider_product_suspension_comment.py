...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "patch",
        "url": f"/service_provider_product_suspension_comment/{id}",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, ErrorMessage, ServiceProviderProductSuspensionCommentResponse, Union["EmptyObject", "ErrorMessage"]]
]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (ServiceProviderProductSuspensionCommentUpdateRequest): Request schema for update
    ...
    Returns:
        Response[Union[Any, ErrorMessage, ServiceProviderProductSuspensionCommentResponse, Union['EmptyObject', 'ErrorMessage']]]
    """
