...
) -> Optional[Union[ErrorMessage, MeteringGridAreaResponse, Union["EmptyObject", "ErrorMessage"]]]:
    if response.status_code == 200:
        response_200 = MeteringGridAreaResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, MeteringGridAreaResponse, Union["EmptyObject", "ErrorMessage"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorMessage, MeteringGridAreaResponse, Union['EmptyObject', 'ErrorMessage']]
    """
