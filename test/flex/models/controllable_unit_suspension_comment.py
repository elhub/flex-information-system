...
T = TypeVar("T", bound="ControllableUnitSuspensionComment")


@_attrs_define
class ControllableUnitSuspensionComment:
    ...
    Attributes:
        ...
        created_at (Union[Unset, str]): When the comment was added to the CUS. Example: 2022-08-08 12:00:00 CET.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_suspension_comment = cls(
        ...
        controllable_unit_suspension_comment.additional_properties = d
        return controllable_unit_suspension_comment
