...
T = TypeVar("T", bound="GridPrequalificationForServiceProvidingGroupCommentResponse")


@_attrs_define
class GridPrequalificationForServiceProvidingGroupCommentResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grid_prequalification_for_service_providing_group_comment_response = cls(
            id=id,
            service_providing_group_grid_prequalification_id=service_providing_group_grid_prequalification_id,
            created_by=created_by,
            created_at=created_at,
        ...
        grid_prequalification_for_service_providing_group_comment_response.additional_properties = d
        return grid_prequalification_for_service_providing_group_comment_response
