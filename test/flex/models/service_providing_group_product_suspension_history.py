...
T = TypeVar("T", bound="ServiceProvidingGroupProductSuspensionHistory")


@_attrs_define
class ServiceProvidingGroupProductSuspensionHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_product_suspension_history = cls(
            id=id,
            procuring_system_operator_id=procuring_system_operator_id,
            service_providing_group_id=service_providing_group_id,
            product_type_ids=product_type_ids,
        ...
        service_providing_group_product_suspension_history.additional_properties = d
        return service_providing_group_product_suspension_history
