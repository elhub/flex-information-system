...
T = TypeVar("T", bound="ServiceProviderProductSuspensionComment")


@_attrs_define
class ServiceProviderProductSuspensionComment:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_provider_product_suspension_comment = cls(
            id=id,
            service_provider_product_suspension_id=service_provider_product_suspension_id,
            created_by=created_by,
            created_at=created_at,
        ...
        service_provider_product_suspension_comment.additional_properties = d
        return service_provider_product_suspension_comment
