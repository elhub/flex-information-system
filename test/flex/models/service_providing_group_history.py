...
T = TypeVar("T", bound="ServiceProvidingGroupHistory")


@_attrs_define
class ServiceProvidingGroupHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_history = cls(
            id=id,
            name=name,
            service_provider_id=service_provider_id,
            bidding_zone=bidding_zone,
        ...
        service_providing_group_history.additional_properties = d
        return service_providing_group_history
