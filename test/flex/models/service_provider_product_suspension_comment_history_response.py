...
T = TypeVar("T", bound="ServiceProviderProductSuspensionCommentHistoryResponse")


@_attrs_define
class ServiceProviderProductSuspensionCommentHistoryResponse:
    ...
    Attributes:
        ...
        created_at (str): When the comment was added to the SPPS. Example: 2022-08-08 12:00:00 CET.
        ...
        service_provider_product_suspension_comment_id (int): Reference to the resource that was updated. Example: 48.
    ...
    recorded_at: str
    recorded_by: int
    service_provider_product_suspension_comment_id: int
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        service_provider_product_suspension_comment_id = self.service_provider_product_suspension_comment_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_provider_product_suspension_comment_id = d.pop("service_provider_product_suspension_comment_id")
        ...
        service_provider_product_suspension_comment_history_response = cls(
            id=id,
            service_provider_product_suspension_id=service_provider_product_suspension_id,
            created_by=created_by,
            created_at=created_at,
        ...
        service_provider_product_suspension_comment_history_response.additional_properties = d
        return service_provider_product_suspension_comment_history_response
