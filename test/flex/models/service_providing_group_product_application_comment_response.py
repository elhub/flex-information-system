...
T = TypeVar("T", bound="ServiceProvidingGroupProductApplicationCommentResponse")


@_attrs_define
class ServiceProvidingGroupProductApplicationCommentResponse:
    ...
    Attributes:
        ...
        created_at (datetime.datetime): When the comment was added to the SPGPA. Example: 2022-08-08 12:00:00+02:00.
        visibility (ServiceProvidingGroupProductApplicationCommentVisibility): The level of visibility of the comment.
            Example: same_party.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visibility = ServiceProvidingGroupProductApplicationCommentVisibility(d.pop("visibility"))
        ...
        service_providing_group_product_application_comment_response = cls(
            id=id,
            service_providing_group_product_application_id=service_providing_group_product_application_id,
            created_by=created_by,
            created_at=created_at,
        ...
        service_providing_group_product_application_comment_response.additional_properties = d
        return service_providing_group_product_application_comment_response
