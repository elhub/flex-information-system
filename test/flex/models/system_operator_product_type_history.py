...
T = TypeVar("T", bound="SystemOperatorProductTypeHistory")


@_attrs_define
class SystemOperatorProductTypeHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_operator_product_type_history = cls(
            id=id,
            system_operator_id=system_operator_id,
            product_type_id=product_type_id,
            status=status,
        ...
        system_operator_product_type_history.additional_properties = d
        return system_operator_product_type_history
