...
T = TypeVar("T", bound="ControllableUnitSuspensionUpdateRequest")
...
class ControllableUnitSuspensionUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_suspension_update_request = cls(
            reason=reason,
        )

        controllable_unit_suspension_update_request.additional_properties = d
        return controllable_unit_suspension_update_request
