...
@_attrs_define
class ServiceProvidingGroupProductApplicationCommentHistoryResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_product_application_comment_history_response = cls(
            id=id,
            service_providing_group_product_application_id=service_providing_group_product_application_id,
            created_by=created_by,
            created_at=created_at,
        ...
        service_providing_group_product_application_comment_history_response.additional_properties = d
        return service_providing_group_product_application_comment_history_response
