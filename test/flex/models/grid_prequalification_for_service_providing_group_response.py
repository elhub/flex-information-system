...
T = TypeVar("T", bound="GridPrequalificationForServiceProvidingGroupResponse")


@_attrs_define
class GridPrequalificationForServiceProvidingGroupResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grid_prequalification_for_service_providing_group_response = cls(
            id=id,
            service_providing_group_id=service_providing_group_id,
            impacted_system_operator_id=impacted_system_operator_id,
            status=status,
        ...
        grid_prequalification_for_service_providing_group_response.additional_properties = d
        return grid_prequalification_for_service_providing_group_response
