...
T = TypeVar("T", bound="ServiceProviderProductSuspensionHistory")


@_attrs_define
class ServiceProviderProductSuspensionHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_provider_product_suspension_history = cls(
            id=id,
            procuring_system_operator_id=procuring_system_operator_id,
            service_provider_id=service_provider_id,
            product_type_ids=product_type_ids,
        ...
        service_provider_product_suspension_history.additional_properties = d
        return service_provider_product_suspension_history
