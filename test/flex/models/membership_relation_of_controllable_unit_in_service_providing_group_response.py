...
T = TypeVar("T", bound="MembershipRelationOfControllableUnitInServiceProvidingGroupResponse")


@_attrs_define
class MembershipRelationOfControllableUnitInServiceProvidingGroupResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        membership_relation_of_controllable_unit_in_service_providing_group_response = cls(
            id=id,
            controllable_unit_id=controllable_unit_id,
            service_providing_group_id=service_providing_group_id,
            valid_from=valid_from,
        ...
        membership_relation_of_controllable_unit_in_service_providing_group_response.additional_properties = d
        return membership_relation_of_controllable_unit_in_service_providing_group_response
