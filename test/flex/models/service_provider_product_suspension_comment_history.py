...
T = TypeVar("T", bound="ServiceProviderProductSuspensionCommentHistory")


@_attrs_define
class ServiceProviderProductSuspensionCommentHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_provider_product_suspension_comment_history = cls(
            id=id,
            service_provider_product_suspension_id=service_provider_product_suspension_id,
            created_by=created_by,
            created_at=created_at,
        ...
        service_provider_product_suspension_comment_history.additional_properties = d
        return service_provider_product_suspension_comment_history
