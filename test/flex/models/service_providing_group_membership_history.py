...
T = TypeVar("T", bound="ServiceProvidingGroupMembershipHistory")


@_attrs_define
class ServiceProvidingGroupMembershipHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_membership_history = cls(
            id=id,
            controllable_unit_id=controllable_unit_id,
            service_providing_group_id=service_providing_group_id,
            valid_from=valid_from,
        ...
        service_providing_group_membership_history.additional_properties = d
        return service_providing_group_membership_history
