...
T = TypeVar("T", bound="ServiceProvidingGroupGridSuspensionCommentCreateData")


@_attrs_define
class ServiceProvidingGroupGridSuspensionCommentCreateData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_grid_suspension_comment_create_data = cls(
            visibility=visibility,
            content=content,
            service_providing_group_grid_suspension_id=service_providing_group_grid_suspension_id,
        )

        service_providing_group_grid_suspension_comment_create_data.additional_properties = d
        return service_providing_group_grid_suspension_comment_create_data
