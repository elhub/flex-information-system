...
T = TypeVar("T", bound="ControllableUnitServiceProviderHistory")


@_attrs_define
class ControllableUnitServiceProviderHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_service_provider_history = cls(
            id=id,
            controllable_unit_id=controllable_unit_id,
            service_provider_id=service_provider_id,
            end_user_id=end_user_id,
        ...
        controllable_unit_service_provider_history.additional_properties = d
        return controllable_unit_service_provider_history
