...
T = TypeVar("T", bound="ServiceProvidingGroupProductSuspensionCommentHistory")


@_attrs_define
class ServiceProvidingGroupProductSuspensionCommentHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_product_suspension_comment_history = cls(
            id=id,
            service_providing_group_product_suspension_id=service_providing_group_product_suspension_id,
            created_by=created_by,
            created_at=created_at,
        ...
        service_providing_group_product_suspension_comment_history.additional_properties = d
        return service_providing_group_product_suspension_comment_history
