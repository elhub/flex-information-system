...
T = TypeVar("T", bound="ServiceProviderProductApplicationComment")


@_attrs_define
class ServiceProviderProductApplicationComment:
    ...
    Attributes:
        ...
        created_at (str | Unset): When the comment was added to the SPPA. Example: 2022-08-08 12:00:00 CET.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_provider_product_application_comment = cls(
        ...
        service_provider_product_application_comment.additional_properties = d
        return service_provider_product_application_comment
