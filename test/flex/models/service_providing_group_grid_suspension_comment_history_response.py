...
@_attrs_define
class ServiceProvidingGroupGridSuspensionCommentHistoryResponse:
    ...
    Attributes:
        ...
        created_at (datetime.datetime): When the comment was added to the SPGGS. Example: 2022-08-08 12:00:00+02:00.
        ...
        service_providing_group_grid_suspension_comment_id (int): Reference to the resource that was updated. Example:
            48.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        service_providing_group_grid_suspension_comment_id = self.service_providing_group_grid_suspension_comment_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_grid_suspension_comment_id = d.pop("service_providing_group_grid_suspension_comment_id")
        ...
        service_providing_group_grid_suspension_comment_history_response = cls(
            id=id,
            service_providing_group_grid_suspension_id=service_providing_group_grid_suspension_id,
            created_by=created_by,
            created_at=created_at,
        ...
        service_providing_group_grid_suspension_comment_history_response.additional_properties = d
        return service_providing_group_grid_suspension_comment_history_response
