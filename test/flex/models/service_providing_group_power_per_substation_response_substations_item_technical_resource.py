...
T = TypeVar("T", bound="ServiceProvidingGroupPowerPerSubstationResponseSubstationsItemTechnicalResource")


@_attrs_define
class ServiceProvidingGroupPowerPerSubstationResponseSubstationsItemTechnicalResource:
    """
    Attributes:
        count (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_power_per_substation_response_substations_item_technical_resource = cls(
            count=count,
            maximum_active_power=maximum_active_power,
        )

        service_providing_group_power_per_substation_response_substations_item_technical_resource.additional_properties = d
        return service_providing_group_power_per_substation_response_substations_item_technical_resource
