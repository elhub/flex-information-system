...
T = TypeVar("T", bound="ControllableUnitSuspensionCommentCreateData")


@_attrs_define
class ControllableUnitSuspensionCommentCreateData:
    """Data of the request schema for create operations - Comment made by a party involved in a controllable unit
    suspension.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_suspension_comment_create_data = cls(
            visibility=visibility,
            content=content,
            controllable_unit_suspension_id=controllable_unit_suspension_id,
        )

        controllable_unit_suspension_comment_create_data.additional_properties = d
        return controllable_unit_suspension_comment_create_data
