...
T = TypeVar("T", bound="ServiceProvidingGroupControllableUnitsApplicationsResponseProductApplicationsItem")


@_attrs_define
class ServiceProvidingGroupControllableUnitsApplicationsResponseProductApplicationsItem:
    """
    Attributes:
        id (int | Unset): The surrogate key of the product application Example: 123.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_controllable_units_applications_response_product_applications_item = cls(
            id=id,
            prequalified_at=prequalified_at,
        )

        service_providing_group_controllable_units_applications_response_product_applications_item.additional_properties = d
        return service_providing_group_controllable_units_applications_response_product_applications_item
