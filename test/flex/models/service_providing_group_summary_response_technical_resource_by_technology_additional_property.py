...
T = TypeVar("T", bound="ServiceProvidingGroupSummaryResponseTechnicalResourceByTechnologyAdditionalProperty")


@_attrs_define
class ServiceProvidingGroupSummaryResponseTechnicalResourceByTechnologyAdditionalProperty:
    """
    Attributes:
        count (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_summary_response_technical_resource_by_technology_additional_property = cls(
            count=count,
            maximum_active_power=maximum_active_power,
        )

        service_providing_group_summary_response_technical_resource_by_technology_additional_property.additional_properties = d
        return service_providing_group_summary_response_technical_resource_by_technology_additional_property
