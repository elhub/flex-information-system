...
T = TypeVar("T", bound="ControllableUnitSummaryResponseTechnicalResourceByCategoryAdditionalProperty")


@_attrs_define
class ControllableUnitSummaryResponseTechnicalResourceByCategoryAdditionalProperty:
    """
    Attributes:
        count (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_summary_response_technical_resource_by_category_additional_property = cls(
            count=count,
            maximum_active_power=maximum_active_power,
        )

        controllable_unit_summary_response_technical_resource_by_category_additional_property.additional_properties = d
        return controllable_unit_summary_response_technical_resource_by_category_additional_property
