...
T = TypeVar("T", bound="PartyMembershipCreateData")


@_attrs_define
class PartyMembershipCreateData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        party_membership_create_data = cls(
            scopes=scopes,
            party_id=party_id,
            entity_id=entity_id,
        )

        party_membership_create_data.additional_properties = d
