...
T = TypeVar("T", bound="ServiceProvidingGroupProductSuspensionCreateRequest")


@_attrs_define
class ServiceProvidingGroupProductSuspensionCreateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_product_suspension_create_request = cls(
        ...
        service_providing_group_product_suspension_create_request.additional_properties = d
        return service_providing_group_product_suspension_create_request
