...
@_attrs_define
class ServiceProvidingGroupGridSuspensionCommentResponse:
    """Response schema for operations with return values - Comment made by a party involved in a service providing group
    grid suspension.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return service_providing_group_grid_suspension_comment_response
