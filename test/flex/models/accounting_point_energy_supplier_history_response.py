...
T = TypeVar("T", bound="AccountingPointEnergySupplierHistoryResponse")


@_attrs_define
class AccountingPointEnergySupplierHistoryResponse:
    """Accounting Point Energy Supplier - history
    ...
    Attributes:
        ...
        accounting_point_energy_supplier_id (Union[Unset, int]): Reference to the resource that was updated. Example:
            48.
    ...
    accounting_point_energy_supplier_id: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        accounting_point_energy_supplier_id = self.accounting_point_energy_supplier_id
        ...
        if accounting_point_energy_supplier_id is not UNSET:
            field_dict["accounting_point_energy_supplier_id"] = accounting_point_energy_supplier_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accounting_point_energy_supplier_id = d.pop("accounting_point_energy_supplier_id", UNSET)
        ...
        accounting_point_energy_supplier_history_response = cls(
            id=id,
            ...
            accounting_point_energy_supplier_id=accounting_point_energy_supplier_id,
            replaced_by=replaced_by,
            replaced_at=replaced_at,
        )

        accounting_point_energy_supplier_history_response.additional_properties = d
        return accounting_point_energy_supplier_history_response
