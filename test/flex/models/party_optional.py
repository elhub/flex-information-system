...
T = TypeVar("T", bound="PartyOptional")


@_attrs_define
class PartyOptional:
    """Schema with optional fields for embedding - The body that interacts with the Flexibility Information System
    ...
    * End User
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        party_optional.additional_properties = d
        return party_optional
