...
T = TypeVar("T", bound="AccountingPointBalanceResponsibleParty")


@_attrs_define
class AccountingPointBalanceResponsibleParty:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        accounting_point_balance_responsible_party = cls(
        ...
        accounting_point_balance_responsible_party.additional_properties = d
        return accounting_point_balance_responsible_party
