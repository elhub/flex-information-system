...
T = TypeVar("T", bound="ServiceProvidingGroupGridPrequalificationHistory")


@_attrs_define
class ServiceProvidingGroupGridPrequalificationHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_grid_prequalification_history = cls(
            id=id,
            service_providing_group_id=service_providing_group_id,
            impacted_system_operator_id=impacted_system_operator_id,
            status=status,
        ...
        service_providing_group_grid_prequalification_history.additional_properties = d
        return service_providing_group_grid_prequalification_history
