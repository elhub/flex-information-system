...
T = TypeVar("T", bound="ServiceProvidingGroupProductSuspensionCommentCreateRequest")


@_attrs_define
class ServiceProvidingGroupProductSuspensionCommentCreateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_product_suspension_comment_create_request = cls(
            service_providing_group_product_suspension_id=service_providing_group_product_suspension_id,
            content=content,
            visibility=visibility,
        )

        service_providing_group_product_suspension_comment_create_request.additional_properties = d
        return service_providing_group_product_suspension_comment_create_request
