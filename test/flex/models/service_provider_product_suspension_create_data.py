...
T = TypeVar("T", bound="ServiceProviderProductSuspensionCreateData")


@_attrs_define
class ServiceProviderProductSuspensionCreateData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_provider_product_suspension_create_data = cls(
        ...
        service_provider_product_suspension_create_data.additional_properties = d
        return service_provider_product_suspension_create_data
