...
T = TypeVar("T", bound="ServiceProviderProductSuspensionCommentUpdateRequest")


@_attrs_define
class ServiceProviderProductSuspensionCommentUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_provider_product_suspension_comment_update_request = cls(
            visibility=visibility,
            content=content,
        )

        service_provider_product_suspension_comment_update_request.additional_properties = d
        return service_provider_product_suspension_comment_update_request
