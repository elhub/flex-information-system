...
T = TypeVar("T", bound="ControllableUnitSummaryResponseAggregatesTechnicalResourceByTechnologyAdditionalProperty")


@_attrs_define
class ControllableUnitSummaryResponseAggregatesTechnicalResourceByTechnologyAdditionalProperty:
    """
    Attributes:
        count (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_summary_response_aggregates_technical_resource_by_technology_additional_property = cls(
            count=count,
            maximum_active_power=maximum_active_power,
        )

        controllable_unit_summary_response_aggregates_technical_resource_by_technology_additional_property.additional_properties = d
        return controllable_unit_summary_response_aggregates_technical_resource_by_technology_additional_property
