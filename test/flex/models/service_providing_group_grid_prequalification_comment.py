...
T = TypeVar("T", bound="ServiceProvidingGroupGridPrequalificationComment")


@_attrs_define
class ServiceProvidingGroupGridPrequalificationComment:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_grid_prequalification_comment = cls(
        ...
        service_providing_group_grid_prequalification_comment.additional_properties = d
        return service_providing_group_grid_prequalification_comment
