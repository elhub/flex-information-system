...
T = TypeVar("T", bound="TechnicalResourceHistory")


@_attrs_define
class TechnicalResourceHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        technical_resource_history = cls(
            id=id,
            name=name,
            controllable_unit_id=controllable_unit_id,
            recorded_at=recorded_at,
        ...
        technical_resource_history.additional_properties = d
        return technical_resource_history
