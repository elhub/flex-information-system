...
T = TypeVar("T", bound="ControllableUnitSuspensionHistory")


@_attrs_define
class ControllableUnitSuspensionHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_suspension_history = cls(
            id=id,
            controllable_unit_id=controllable_unit_id,
            impacted_system_operator_id=impacted_system_operator_id,
            reason=reason,
        ...
        controllable_unit_suspension_history.additional_properties = d
        return controllable_unit_suspension_history
