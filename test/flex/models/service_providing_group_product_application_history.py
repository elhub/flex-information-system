...
T = TypeVar("T", bound="ServiceProvidingGroupProductApplicationHistory")


@_attrs_define
class ServiceProvidingGroupProductApplicationHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_product_application_history = cls(
            id=id,
            service_providing_group_id=service_providing_group_id,
            procuring_system_operator_id=procuring_system_operator_id,
            product_type_ids=product_type_ids,
        ...
        service_providing_group_product_application_history.additional_properties = d
        return service_providing_group_product_application_history
