...
class ServiceProvidingGroupGridPrequalificationCommentHistoryResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_grid_prequalification_comment_history_response.additional_properties = d
        return service_providing_group_grid_prequalification_comment_history_response
