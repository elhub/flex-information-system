...
T = TypeVar("T", bound="ServiceProvidingGroupGridPrequalificationCommentCreateData")


@_attrs_define
class ServiceProvidingGroupGridPrequalificationCommentCreateData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_grid_prequalification_comment_create_data = cls(
            visibility=visibility,
            content=content,
            service_providing_group_grid_prequalification_id=service_providing_group_grid_prequalification_id,
        )

        service_providing_group_grid_prequalification_comment_create_data.additional_properties = d
        return service_providing_group_grid_prequalification_comment_create_data
