...
T = TypeVar("T", bound="ServiceProvidingGroupGridPrequalificationCommentUpdateRequest")


@_attrs_define
class ServiceProvidingGroupGridPrequalificationCommentUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_grid_prequalification_comment_update_request = cls(
            visibility=visibility,
            content=content,
        )

        service_providing_group_grid_prequalification_comment_update_request.additional_properties = d
        return service_providing_group_grid_prequalification_comment_update_request
