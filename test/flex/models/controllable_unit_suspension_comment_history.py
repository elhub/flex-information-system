...
T = TypeVar("T", bound="ControllableUnitSuspensionCommentHistory")


@_attrs_define
class ControllableUnitSuspensionCommentHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_suspension_comment_history = cls(
            id=id,
            controllable_unit_suspension_id=controllable_unit_suspension_id,
            created_by=created_by,
            created_at=created_at,
        ...
        controllable_unit_suspension_comment_history.additional_properties = d
        return controllable_unit_suspension_comment_history
