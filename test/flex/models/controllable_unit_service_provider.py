...
T = TypeVar("T", bound="ControllableUnitServiceProvider")


@_attrs_define
class ControllableUnitServiceProvider:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controllable_unit_service_provider = cls(
            id=id,
            controllable_unit_id=controllable_unit_id,
            service_provider_id=service_provider_id,
            end_user_id=end_user_id,
        ...
        controllable_unit_service_provider.additional_properties = d
        return controllable_unit_service_provider
