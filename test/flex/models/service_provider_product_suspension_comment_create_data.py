...
T = TypeVar("T", bound="ServiceProviderProductSuspensionCommentCreateData")


@_attrs_define
class ServiceProviderProductSuspensionCommentCreateData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_provider_product_suspension_comment_create_data = cls(
            visibility=visibility,
            content=content,
            service_provider_product_suspension_id=service_provider_product_suspension_id,
        )

        service_provider_product_suspension_comment_create_data.additional_properties = d
        return service_provider_product_suspension_comment_create_data
