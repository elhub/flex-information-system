...
T = TypeVar("T", bound="ServiceProvidingGroupSummaryResponseTechnicalResourceByCategoryAdditionalProperty")


@_attrs_define
class ServiceProvidingGroupSummaryResponseTechnicalResourceByCategoryAdditionalProperty:
    """
    Attributes:
        count (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_summary_response_technical_resource_by_category_additional_property = cls(
            count=count,
            maximum_active_power=maximum_active_power,
        )

        service_providing_group_summary_response_technical_resource_by_category_additional_property.additional_properties = d
        return service_providing_group_summary_response_technical_resource_by_category_additional_property
