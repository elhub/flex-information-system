...
T = TypeVar("T", bound="ServiceProvidingGroupGridSuspensionHistory")


@_attrs_define
class ServiceProvidingGroupGridSuspensionHistory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_grid_suspension_history = cls(
            id=id,
            impacted_system_operator_id=impacted_system_operator_id,
            service_providing_group_id=service_providing_group_id,
            reason=reason,
        ...
        service_providing_group_grid_suspension_history.additional_properties = d
        return service_providing_group_grid_suspension_history
