...
T = TypeVar("T", bound="ServiceProvidingGroupProductSuspensionCommentUpdateRequest")


@_attrs_define
class ServiceProvidingGroupProductSuspensionCommentUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_providing_group_product_suspension_comment_update_request = cls(
            visibility=visibility,
            content=content,
        )

        service_providing_group_product_suspension_comment_update_request.additional_properties = d
        return service_providing_group_product_suspension_comment_update_request
