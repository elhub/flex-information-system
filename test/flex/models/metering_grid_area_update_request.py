...
T = TypeVar("T", bound="MeteringGridAreaUpdateRequest")


@_attrs_define
class MeteringGridAreaUpdateRequest:
    """Request schema for update operations - Metering grid area owned by a system operator.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metering_grid_area_update_request = cls(
            price_area=price_area,
            valid_from=valid_from,
            valid_to=valid_to,
        )

        metering_grid_area_update_request.additional_properties = d
        return metering_grid_area_update_request
