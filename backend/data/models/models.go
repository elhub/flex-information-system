...
type ApiControllableUnitSummary struct {
	ID                                 int
	CountTechnicalResource             int
	CountTechnicalResourceByTechnology []byte
	SumMaximumActivePower              float64
	SumMaximumActivePowerProduction    float64
	SumMaximumActivePowerConsumption   float64
	SumMaximumActivePowerEnergyStorage float64
	AverageMaximumActivePower          float64
}
