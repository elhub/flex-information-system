-- Copied from https://github.com/nearform/temporal_tables
-- See ./LICENSE

-- Copy of https://github.com/nearform/temporal_tables/blob/master/system_time_function.sql
-- version 0.5.0
...
-- Copy of https://github.com/nearform/temporal_tables/blob/master/versioning_function.sql
-- version 0.5.0
CREATE OR REPLACE FUNCTION versioning()
RETURNS trigger
-- SECURITY DEFINER set by Elhub
SECURITY DEFINER
AS $$
DECLARE
  sys_period text;
