...
GRANT SELECT ON TABLE flex.service_providing_group_grid_suspension_history
TO flex_balance_responsible_party;
...
GRANT SELECT ON TABLE flex.service_provider_product_suspension
TO flex_balance_responsible_party;
...
GRANT INSERT ON TABLE flex.service_provider_product_suspension
TO flex_flexibility_information_system_operator;
...
GRANT UPDATE ON TABLE flex.service_provider_product_suspension
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-fiso-delete endDelimiter:-- runAlways:true
GRANT DELETE ON TABLE flex.service_provider_product_suspension
TO flex_flexibility_information_system_operator;
...
GRANT SELECT ON TABLE flex.service_provider_product_suspension_history
TO flex_balance_responsible_party;
...
GRANT SELECT ON TABLE flex.service_provider_product_suspension_comment
TO flex_balance_responsible_party;
...
GRANT INSERT ON TABLE flex.service_provider_product_suspension_comment
TO flex_flexibility_information_system_operator;
...
GRANT UPDATE ON TABLE flex.service_provider_product_suspension_comment
TO flex_flexibility_information_system_operator;
...
GRANT SELECT ON TABLE flex.service_provider_product_suspension_comment_history
TO flex_balance_responsible_party;
