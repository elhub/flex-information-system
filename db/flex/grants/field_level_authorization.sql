...
-- changeset flex:flex-grant-controllable-unit-suspension-comment-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_energy_supplier;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_end_user;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-fiso-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-fiso-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.controllable_unit_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_market_operator;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-so-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-so-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.controllable_unit_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-sp-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-sp-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.controllable_unit_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-controllable-unit-suspension-comment-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.controllable_unit_suspension_comment
TO flex_third_party;
...
-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_end_user;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_market_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_third_party;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-history-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_history
TO flex_internal_event_notification;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_end_user;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-fiso-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-fiso-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_market_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-so-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-so-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-sp-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-sp-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_third_party;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment
TO flex_internal_event_notification;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_end_user;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_market_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_third_party;

-- changeset flex:flex-grant-service-providing-group-grid-suspension-comment-history-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_grid_suspension_comment_history
TO flex_internal_event_notification;
...
-- changeset flex:flex-grant-metering-grid-area-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.metering_grid_area
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-metering-grid-area-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.metering_grid_area
TO flex_energy_supplier;

-- changeset flex:flex-grant-metering-grid-area-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.metering_grid_area
TO flex_end_user;

-- changeset flex:flex-grant-metering-grid-area-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.metering_grid_area
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-metering-grid-area-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.metering_grid_area
TO flex_market_operator;

-- changeset flex:flex-grant-metering-grid-area-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.metering_grid_area
TO flex_system_operator;

-- changeset flex:flex-grant-metering-grid-area-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.metering_grid_area
TO flex_service_provider;

-- changeset flex:flex-grant-metering-grid-area-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.metering_grid_area
TO flex_third_party;
...
-- changeset flex:flex-grant-service-provider-product-suspension-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-provider-product-suspension-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-provider-product-suspension-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_end_user;

-- changeset flex:flex-grant-service-provider-product-suspension-fiso-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_provider_product_suspension
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-fiso-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_provider_product_suspension
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-fiso-delete endDelimiter:-- runAlways:true
GRANT DELETE ON TABLE
flex.service_provider_product_suspension
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_market_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-so-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_provider_product_suspension
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-so-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_provider_product_suspension
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-so-delete endDelimiter:-- runAlways:true
GRANT DELETE ON TABLE
flex.service_provider_product_suspension
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_service_provider;

-- changeset flex:flex-grant-service-provider-product-suspension-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_third_party;

-- changeset flex:flex-grant-service-provider-product-suspension-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension
TO flex_internal_event_notification;

-- changeset flex:flex-grant-service-provider-product-suspension-history-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-provider-product-suspension-history-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-provider-product-suspension-history-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_end_user;

-- changeset flex:flex-grant-service-provider-product-suspension-history-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-history-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_market_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-history-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-history-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_service_provider;

-- changeset flex:flex-grant-service-provider-product-suspension-history-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_third_party;

-- changeset flex:flex-grant-service-provider-product-suspension-history-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_history
TO flex_internal_event_notification;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_end_user;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-fiso-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-fiso-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_provider_product_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_market_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-so-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-so-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_provider_product_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-sp-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-sp-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_provider_product_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_third_party;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment
TO flex_internal_event_notification;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_end_user;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_market_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_system_operator;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_service_provider;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_third_party;

-- changeset flex:flex-grant-service-provider-product-suspension-comment-history-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_provider_product_suspension_comment_history
TO flex_internal_event_notification;
...
-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_end_user;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-fiso-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-fiso-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_market_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-so-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-so-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-sp-insert endDelimiter:-- runAlways:true
GRANT INSERT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-sp-update endDelimiter:-- runAlways:true
GRANT UPDATE ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_third_party;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment
TO flex_internal_event_notification;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-brp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_balance_responsible_party;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-es-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_energy_supplier;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-eu-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_end_user;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-fiso-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_flexibility_information_system_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-mo-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_market_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-so-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_system_operator;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-sp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_service_provider;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-tp-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_third_party;

-- changeset flex:flex-grant-service-providing-group-product-suspension-comment-history-ien-select endDelimiter:-- runAlways:true
GRANT SELECT ON TABLE
flex.service_providing_group_product_suspension_comment_history
TO flex_internal_event_notification;
