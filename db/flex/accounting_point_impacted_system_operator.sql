...
-- changeset flex:accounting-point-impacted-system-operator-create runOnChange:true endDelimiter:--
CREATE OR REPLACE VIEW accounting_point_impacted_system_operator
...
GRANT SELECT ON TABLE accounting_point_impacted_system_operator
TO flex_common;
