...
CREATE TABLE IF NOT EXISTS flex.service_providing_group_product_application_comment (
...
-- changeset flex:service-providing-group-product-application-comment-visibility-check runOnChange:true endDelimiter:--
ALTER TABLE flex.service_providing_group_product_application_comment
