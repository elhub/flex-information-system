...
-- changeset flex:api-accounting-point-grid-location-create endDelimiter:-- runAlways:true
...
-- changeset flex:api-accounting-point-grid-location-history-create endDelimiter:-- runAlways:true
CREATE OR REPLACE VIEW
