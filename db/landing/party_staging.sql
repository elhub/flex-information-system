...
CREATE TABLE IF NOT EXISTS landing.party_staging (
    id bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
    gln text CHECK (utils.validate_business_id(gln, 'gln')),
    org text NOT NULL CHECK (utils.validate_business_id(org, 'org')),
    name text NOT NULL,
    type text NOT NULL,
