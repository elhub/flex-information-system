...
BEGIN
  ...
  INSERT INTO flex.party_membership (
    ...
    member_entity_id,
    party_id,
    '{manage:data, manage:auth, manage:attachment}'
  );
...
BEGIN
  ...
  VALUES
  (entity_id_person, 'PC #1', '{manage:auth, manage:data, manage:attachment}'::text[]),
  (entity_id_org, 'Laptop #4', '{manage:auth, manage:data, manage:attachment}'::text[]);
