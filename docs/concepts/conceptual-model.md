...
> the party type definitions in the [Auth section](../auth/index.md),
...
A [service provider](../auth/authn-model.md#service-provider) (SP)
...
[balance responsible party](../auth/authn-model.md#balance-responsible-party)
(BRP) of the associated
[energy supplier](../auth/authn-model.md#energy-supplier) (ES), which
enables imbalance adjustment and settlement.

Knowing the AP where a CU is located also allows
[system operators](../auth/authn-model.md#system-operator) (SOs) to
