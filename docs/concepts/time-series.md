...
that the delivered service is of sufficient quality.
...
- **Consistency checks** - check delivery and bid volume over time to see if there
are repeated discrepancies or systematic errors.
