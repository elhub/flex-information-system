...
| <a name="field-latitude" href="#field-latitude">latitude</a>                               | Geographic latitude of the accounting point (WGS84).               | double<br/>Min: `-90`<br/>Max: `90`<br/>Read only   |                               |
| <a name="field-longitude" href="#field-longitude">longitude</a>                            | Geographic longitude of the accounting point (WGS84).              | double<br/>Min: `-180`<br/>Max: `180`<br/>Read only |                               |
...
| latitude           |      | R   | R  | R  | R    | R  | R  | R  |     |
| longitude          |      | R   | R  | R  | R    | R  | R  | R  |     |
