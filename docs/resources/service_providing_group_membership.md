...
| SPGM-VAL003         | The flexible power of the controllable unit must not exceed 80% of the combined maximum active power of all its technical resources. | DONE   |
