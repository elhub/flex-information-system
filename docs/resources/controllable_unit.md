...
* [API Documentation](../api/v1/index.html#/operations/list_controllable_unit)
...
| <a name="field-maximum_active_power" href="#field-maximum_active_power">maximum_active_power</a>       | Maximum continuous active power (flexible power) that the controllable unit can produce or consume, i.e. deliver for balancing and congestion services, in kilowatts.                           | decimal<br/>Required<br/>Min: `0`<br/>Max: `999999.999`<br/>Multiple of: `0.001`                                                                                                                               |                                                     |
| <a name="field-is_small" href="#field-is_small">is_small</a>                                           | Whether the controllable unit is small or not, following NCDR. Current threshold for this to be true is <= 50 kW of flexible power.                                                             | boolean<br/>Read only                                                                                                                                                                                          |                                                     |
