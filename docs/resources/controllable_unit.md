...
| <a name="field-regulation_direction" href="#field-regulation_direction">regulation_direction</a>                            | The regulation direction of the controllable unit.                                                                                                   | text<br/>One of: `up`, `down`, `both`<br/>Required                                                                                                                                                              |                               |
...
| <a name="field-accounting_point_id" href="#field-accounting_point_id">accounting_point_id</a>                               | The existing accounting point that the controllable unit is connected to.<br/>`GSRN` metering point id.                                              | text<br/>Pattern: `^[1-9][0-9]{17}$`<br/>Required                                                                                                                                                               |                               |
...
| <a name="field-connecting_system_operator_id" href="#field-connecting_system_operator_id">connecting_system_operator_id</a> | Reference to the `party` that is the connecting system operator. Derived from the `accounting_point_id`.                                             | bigint<br/>Read only                                                                                                                                                                                            | [party.id](party.md#field-id) |
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------|--------|
| CU-IFV001           | If both `minimum_duration` and `maximum_duration` are specified, then the minimum duration must be lower than the maximum duration. | DONE   |
...
| connecting_system_operator_id |      | R   | R  | R  | R    | R  | R  | R   | R  |
