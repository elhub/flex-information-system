...
| <a name="field-accounting_point_id" href="#field-accounting_point_id">accounting_point_id</a>                               | Reference to the accounting point that the controllable unit is connected to.                                                                                                                   | bigint<br/>Read only                                                                                                                                                                                            | [accounting_point.id](accounting_point.md#field-id) |
