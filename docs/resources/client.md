...
* [API Documentation](/api/v0/#/operations/list_client)
* [Download docx](/docs/download/client.docx)
...
| <a name="field-secret" href="#field-secret">secret</a>                | The secret of the entity. For use with client credentials authentication method. Input as plain text but stored encrypted. | text<br/>Min length: `12`                                                                               |                                 |
...
|------------|----------------------------------------------------|--------|
| CLI-ENT001 | Read, create, update and delete their own clients. | DONE   |
...
| Policy key  | Policy            | Status |
|-------------|-------------------|--------|
| CLI-FISO001 | Read all clients. | DONE   |
