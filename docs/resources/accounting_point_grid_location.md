...
| <a name="field-accounting_point_id" href="#field-accounting_point_id">accounting_point_id</a>          | The accounting point this grid location belongs to. An accounting point can only have one grid location - limited by a unique constraint | bigint<br/>Required                                               | [accounting_point.id](accounting_point.md#field-id) |
...
| <a name="field-business_id" href="#field-business_id">business_id</a>                                  | Business identifier (mRID) referencing the object in the common grid model.                                                              | text                                                              |                                                     |
...
| <a name="field-nominal_voltage" href="#field-nominal_voltage">nominal_voltage</a>                      | Nominal voltage level at the grid location. Stored in kilovolt (kV).                                                                     | decimal<br/>Required<br/>Min: `0`                                 |                                                     |
...
| Policy key | Policy                                                                    | Status |
|------------|---------------------------------------------------------------------------|--------|
| APGL-SO001 | Read, Create and update accounting point grid locations where they are SO | TODO   |
| APGL-SO002 | Read history on accounting point grid locations where they are SO         | TODO   |
