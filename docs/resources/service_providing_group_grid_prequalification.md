...
* [API Documentation](../api/v1/index.html#/operations/list_service_providing_group_grid_prequalification)
...
| <a name="field-prequalified_at" href="#field-prequalified_at">prequalified_at</a>                                     | When the current grid prequalification was last approved.                                                | date-time                                                                                                                                                                                                     |                                                                   |
