...
| <a name="field-category" href="#field-category">category</a>                                                 | Categories derived from the technologies of the technical resource. Automatically computed based on the selected technologies.                         | <br/>Array<br/>One of: `consumption`, `production`, `energy_storage`<br/>Read only                                                                                                                                                                                                                                                                                                             |                                                       |
