...
| no.elhub.flex.service_providing_group_membership.price_area_mismatch                | Inconsistency: The CUs price area does not match the one on the SPG                     | SP                | End the SPG membership                                                                                            |
