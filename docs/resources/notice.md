...
|-------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|-------------------|-------------------------------------------------------------------------------------------------------------------------------|
| no.elhub.flex.accounting_point_grid_location.missing                                | Accounting point has no grid location registered                                        | CSO               | Register a grid location for the accounting point                                                                             |
| no.elhub.flex.accounting_point_grid_location.source_insufficient                    | Grid location source must be `cso` or `grid_model` for APs with CUs that are not small  | CSO               | Confirm or update the grid location                                                                                           |
...
| no.elhub.flex.controllable_unit.maximum_active_power.ratio                          | Inconsistency: Flexible power exceeds rated power                                       | SP                | Update the flexible power or add technical resources                                                                          |
...
| no.elhub.flex.controllable_unit.service_providing_group.product_duplication         | Inconsistency: CU registered in multiple SPGs with active applications for the same product | PSO          | Remove the CU from one of the SPGs or cancel one of the conflicting product applications                                     |
...
| <a name="field-data" href="#field-data">data</a>                      | The data of the notice.                                            | <br/>Object<br/>Read only                                       |                               |
