...
| <a name="field-scopes" href="#field-scopes">scopes</a>                | List of scopes granted to the entity when it acts as the party. Scopes are inspired from OAuth 2.0 and allow refinement of access control and privilege delegation mechanisms. | <br/>Required<br/>Array<br/>See [OpenAPI spec](https://elhub.github.io/flex-information-system/api/v1/) for allowed values. |                                 |
