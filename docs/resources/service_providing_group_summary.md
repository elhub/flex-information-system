...
| <a name="field-controllable_unit" href="#field-controllable_unit">controllable_unit</a>                            | Aggregated statistics on controllable units currently in the service providing group, including count, maximum active power information (sum, average, min, max), and flexible power breakdowns total, up and down (sum, average, min, max).  | <br/>Object<br/>Read only |                                                                   |
