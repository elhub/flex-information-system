...
| <a name="field-controllable_unit" href="#field-controllable_unit">controllable_unit</a>                            | Aggregated statistics on controllable units currently in the service providing group, including count and maximum active power breakdowns (sum, average, min, max) by category and technology.                                                | <br/>Object<br/>Read only |                                                                   |
