...
| <a name="field-total_prequalified_volume" href="#field-total_prequalified_volume">total_prequalified_volume</a>          | The total prequalified volume applied for, in kilowatts.                                                        | decimal<br/>Required<br/>Min: `0`<br/>Max: `999999.999`<br/>Multiple of: `0.001`                                                                                |                                                                   |
...
| total_prequalified_volume    |      | R   | R  | R  | RU   | R  | RCU | R  |     |
