...
provider can then make updates and propose the application again.

The system will regularly check automatically whether SPG grid prequalification
resources need to be created for each impacted system operator, and any status
change from `requested` will trigger this check as well.
...
| <a name="field-status" href="#field-status">status</a>                                                                   | The status of the application.                                                                                  | text<br/>One of: `requested`, `prequalification`, `temporary_qualified`, `prequalified`, `verified`, `rejected`<br/>Default: `requested` |                                                                   |
| <a name="field-maximum_active_power_up" href="#field-maximum_active_power_up">maximum_active_power_up</a>                | The maximum active power applied for in regulation direction up. Stored in kilowatts.                           | decimal<br/>Required<br/>Min: `0`<br/>Max: `999999.999`<br/>Multiple of: `0.001`                                                         |                                                                   |
| <a name="field-maximum_active_power_down" href="#field-maximum_active_power_down">maximum_active_power_down</a>          | The maximum active power applied for in regulation direction down. Stored in kilowatts.                         | decimal<br/>Required<br/>Min: `0`<br/>Max: `999999.999`<br/>Multiple of: `0.001`                                                         |                                                                   |
...
| <a name="field-ramping_capability" href="#field-ramping_capability">ramping_capability</a>                               | The ramping capability of the service providing group for this product application.                             | text<br/>One of: `always`, `partial`, `never`<br/>Required                                                                               |                                                                   |
| <a name="field-ramping_description" href="#field-ramping_description">ramping_description</a>                            | Free text description of ramping details.                                                                       | text                                                                                                                                     |                                                                   |
...
| SPGPA-VAL003        | The SP opening the product application must be qualified by the SO or have an ongoing qualification for all the product types.   | DONE   |
...
| SPGPA-SO003 | Read SPGPA for SPGs on which they have a grid prequalification.    | DONE   |
