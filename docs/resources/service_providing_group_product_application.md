...
again.
Before the status is set to `prequalified`, it goes through an intermediate step
called `ready_for_grid_prequalification` where SPG grid prequalification
resources are created for each impacted system operator.
...
| <a name="field-status" href="#field-status">status</a>                                                                   | The status of the application.                                                                                  | text<br/>One of: `requested`, `prequalification_pending`, `in_progress`, `temporary_qualified`, `ready_for_grid_prequalification`, `prequalified`, `verified`, `rejected`<br/>Default: `requested` |                                                                   |
