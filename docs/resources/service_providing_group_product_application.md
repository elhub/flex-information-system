...
| <a name="field-maximum_active_power" href="#field-maximum_active_power">maximum_active_power</a>                         | The maximum active power applied for. Stored in kilowatts.                                                      | decimal<br/>Required<br/>Min: `0`<br/>Max: `999999.999`<br/>Multiple of: `0.001`                                                                                |                                                                   |
...
| maximum_active_power         |      | R   | R  | R  | RU   | R  | RCU | R  |     |
