...
| <a name="field-maximum_active_power_up" href="#field-maximum_active_power_up">maximum_active_power_up</a>                | The maximum active power applied for in the upward direction. Stored in kilowatts.                              | decimal<br/>Required<br/>Min: `0`<br/>Max: `999999.999`<br/>Multiple of: `0.001`                                                                                |                                                                   |
| <a name="field-maximum_active_power_down" href="#field-maximum_active_power_down">maximum_active_power_down</a>          | The maximum active power applied for in the downward direction. Stored in kilowatts.                            | decimal<br/>Required<br/>Min: `0`<br/>Max: `999999.999`<br/>Multiple of: `0.001`                                                                                |                                                                   |
