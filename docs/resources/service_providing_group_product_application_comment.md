...
* [API Documentation](../api/v1/index.html#/operations/list_service_providing_group_product_application_comment)
...
| <a name="field-visibility" href="#field-visibility">visibility</a>                                                                                                             | The level of visibility of the comment.                            | text<br/>One of: `same_party`, `same_party_type`, `any_involved_party`<br/>Default: `same_party`<br/><br/>Comments marked `same_party` are visible only to the party that creates them. Comments marked `same_party_type` are visible to all involved parties of the same type as the creator (e.g. all involved system operators). Comments marked `any_involved_party` can be seen by all parties involved in the SPGPA. |                                                                                                           |
