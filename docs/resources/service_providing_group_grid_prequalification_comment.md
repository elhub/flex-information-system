...
* [API Documentation](../api/v0/index.html#/operations/list_service_providing_group_prequalification_comment)
* [Download docx](../download/service_providing_group_prequalification_comment.docx)
...
| <a name="field-service_providing_group_grid_prequalification_id" href="#field-service_providing_group_prequalification_id">service_providing_group_grid_prequalification_id</a> | Reference to the service providing group grid suspension.          | bigint<br/>Required<br/>Non-updatable                                                                                                                                                                                                                               | [service_providing_group_grid_prequalification.id](service_providing_group_grid_prequalification.md#field-id) |
...
| <a name="field-created_at" href="#field-created_at">created_at</a>                                                                                                 | When the comment was added to the SPGGP.                           | timestamp with time zone<br/>Read only                                                                                                                                                                                                                              |                                                                                                   |
...
|--------------------------------------------|------|-----|----|----|------|----|-----|-----|----|-----|
| id                                         |      | R   | R  | R  | R    | R  | R   | R   | R  |     |
| service_providing_group_grid_prequalification_id |      | R   | R  | R  | RC   | R  | RC  | RC  | R  |     |
