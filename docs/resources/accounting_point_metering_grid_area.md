...
| <a name="field-valid_from" href="#field-valid_from">valid_from</a>                                  | The date from which the accounting point belongs to the metering grid area. Midnight aligned on Norwegian timezone.  | date-time<br/>Read only |                                                         |
| <a name="field-valid_to" href="#field-valid_to">valid_to</a>                                        | The date until which the accounting point belongs to the metering grid area. Midnight aligned on Norwegian timezone. | date-time<br/>Read only |                                                         |
...
| metering_grid_area_id |      | R   | R  | R  | R    | R  | R  | R  |     |
