...
| **Data**     | `[resource]`                | All fields for the resource, including read-only fields (such as audit fields), with all _non-nullable_ fields marked as required |
| **Response** | `[resource]_response`       | Alias for **Data** schema                                                                                                         |
