...
/**
 * Request schema for create operations - Relation between a service providing group and a system
 * operator for a product type, for the SPG to deliver a product to the SO later.
 */
@Serializable
public data class ServiceProvidingGroupProductApplicationCreateRequest(
  /**
