...
A list of accounting points that are already generated using the test data package can be found in the [test data docs](https://elhub.github.io/flex-information-system/guides/test-data/).
...
If we want some accounting points that do _not_ exist in the test data package and thus trigger a new sync, we can modify some of the zeros and [calculate a new check digit](https://www.gs1.org/services/check-digit-calculator).
