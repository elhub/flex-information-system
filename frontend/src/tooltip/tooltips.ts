...
export const tooltips = {
  "controllable_unit.id": "Unique surrogate key.",
  "controllable_unit.business_id":
    "Unique business identifier for the controllable unit.",
  "controllable_unit.name": "Free text name of the controllable unit.",
  ...
  "controllable_unit_history.id": "Unique surrogate identifier.",
  "controllable_unit_history.business_id":
    "Unique business identifier for the controllable unit.",
  "controllable_unit_history.name": "Free text name of the controllable unit.",
  ...
  "controllable_unit_history.replaced_at": "When the resource was replaced.",
  "controllable_unit_history.replaced_by":
    "The identity that replaced the resource.",
  "controllable_unit_suspension.id": "Unique surrogate identifier.",
  ...
  "controllable_unit_suspension.reason": "The reason for the suspension.",
  "controllable_unit_suspension.recorded_at":
    "When the resource was recorded (created or updated) in the system.",
  "controllable_unit_suspension.recorded_by":
    "The identity that recorded the resource.",
  "controllable_unit_suspension_history.id": "Unique surrogate identifier.",
  ...
  "controllable_unit_suspension_history.replaced_by":
    "The identity that replaced the resource.",
  "controllable_unit_suspension_comment.id": "Unique surrogate identifier.",
  ...
  "controllable_unit_service_provider.id": "Unique surrogate key.",
  ...
  "controllable_unit_service_provider_history.replaced_by":
    "The identity that replaced the resource.",
  "controllable_unit_summary.id": "Unique surrogate key.",
  ...
  "service_providing_group.recorded_by":
    "The identity that recorded the resource.",
  "service_providing_group_history.id": "Unique surrogate identifier.",
  ...
  "service_providing_group_membership_history.replaced_by":
    "The identity that replaced the resource.",
  "service_providing_group_grid_prequalification.id": "Unique surrogate key.",
  ...
  "service_providing_group_grid_prequalification_comment_history.replaced_by":
    "The identity that replaced the comment.",
  "service_providing_group_grid_suspension.id": "Unique surrogate identifier.",
  ...
  "service_providing_group_grid_suspension_comment_history.replaced_by":
    "The identity that replaced the comment.",
  "entity.id": "Unique surrogate identifier.\n\nNote:\nThis is a Primary Key.",
  "entity.business_id":
    "The business identifier of the entity. Format depends on `business_id_type`.",
  "entity.business_id_type": "The type of the business identifier.",
  "entity.name": "Name of the entity. Maximum 128 characters.",
  "entity.type": "The type of the entity, e.g Person, Organisation",
  "entity.recorded_at":
    "When the resource was recorded (created or updated) in the system.",
  "entity.recorded_by": "The identity that recorded the resource.",
  "entity_client.id": "Unique surrogate identifier.",
  ...
  "entity_client.recorded_at":
    "When the resource was recorded (created or updated) in the system.",
  "entity_client.recorded_by": "The identity that recorded the resource.",
  "party.id": "Unique surrogate identifier.",
  "party.business_id":
    "The business identifier of the party. Format depends on `business_id_type`.",
  "party.business_id_type": "The type of the business identifier.",
  "party.entity_id": "Reference to the entity that is the parent of the party.",
  "party.name": "Name of the party. Maximum 128 characters.",
  "party.role":
    "The role of the party. Currently maps to 1:1 to `type`. E.g. system_operator, service_provider.",
  "party.type": "The type of the party, e.g SystemOperator, ServiceProvider",
  "party.status": "The status of the party.",
  "party.recorded_at":
    "When the resource was recorded (created or updated) in the system.",
  "party.recorded_by": "The identity that recorded the resource.",
  "party_history.id": "Unique surrogate identifier.",
  "party_history.business_id":
    "The business identifier of the party. Format depends on `business_id_type`.",
  "party_history.business_id_type": "The type of the business identifier.",
  "party_history.entity_id":
    "Reference to the entity that is the parent of the party.",
  "party_history.name": "Name of the party. Maximum 128 characters.",
  "party_history.role":
    "The role of the party. Currently maps to 1:1 to `type`. E.g. system_operator, service_provider.",
  "party_history.type":
    "The type of the party, e.g SystemOperator, ServiceProvider",
  "party_history.status": "The status of the party.",
  "party_history.recorded_at":
    "When the resource was recorded (created or updated) in the system.",
  "party_history.recorded_by": "The identity that recorded the resource.",
  "party_history.party_id": "Unique surrogate identifier.",
  "party_history.replaced_at": "When the resource was replaced.",
  "party_history.replaced_by": "The identity that replaced the resource.",
  "party_membership.id": "Unique surrogate identifier.",
  ...
  "party_membership.recorded_at":
    "When the resource was recorded (created or updated) in the system.",
  "party_membership.recorded_by": "The identity that recorded the resource.",
  "party_membership_history.id": "Unique surrogate identifier.",
  ...
  "party_membership_history.party_membership_id":
    "Unique surrogate identifier.",
  "party_membership_history.replaced_at": "When the resource was replaced.",
  "party_membership_history.replaced_by":
    "The identity that replaced the resource.",
  "identity.id": "Unique surrogate identifier.",
  "identity.entity_id": "Reference to the entity using the identity.",
  "identity.entity_name": "Name of the entity using the identity.",
  "identity.party_id": "Reference to the party assumed by the entity.",
  "identity.party_name": "Name of the party assumed by the entity.",
  "technical_resource.id": "Unique surrogate identifier.",
  ...
  "technical_resource_history.id": "Unique surrogate identifier.",
  ...
  "technical_resource_history.technical_resource_id":
    "Unique surrogate identifier.",
  "technical_resource_history.replaced_at": "When the resource was replaced.",
  "technical_resource_history.replaced_by":
    "The identity that replaced the resource.",
  "event.id": "Unique surrogate identifier.",
  "event.specversion":
    "The version of the CloudEvents specification followed by the resource.",
  "event.time": "The time at which the event was generated.",
  "event.type": "The type of the event.",
  "event.source": "The URI of the resource concerned by the event.",
  "event.subject":
    "The URI of the specific subject of the event within the resource pointed by `source`.",
  "event.data": "The data of the event.",
  "notification.id": "Unique surrogate identifier.",
  "notification.acknowledged":
    "Whether the notification was acknowledged by the target user.",
  "notification.event_id": "Reference to the event notified by this resource.",
  "notification.party_id":
    "Reference to the party concerned by this notification.",
  "notification.recorded_at":
    "When the resource was recorded (created or updated) in the system.",
  "notification.recorded_by": "The identity that recorded the resource.",
  "accounting_point.id": "Unique surrogate identifier.",
  ...
  "product_type.service": "The service offered by the product type.",
  "product_type.products":
    "Examples of products belonging to this product type.",
  "system_operator_product_type.id": "Unique surrogate identifier.",
  ...
  "system_operator_product_type.status": "The status of the relation.",
  "system_operator_product_type.recorded_at":
    "When the resource was recorded (created or updated) in the system.",
  "system_operator_product_type.recorded_by":
    "The identity that recorded the resource.",
  "system_operator_product_type_history.id": "Unique surrogate identifier.",
  "system_operator_product_type_history.system_operator_id":
    "Reference to the system operator.",
  "system_operator_product_type_history.product_type_id":
    "Reference to the product type.",
  "system_operator_product_type_history.status": "The status of the relation.",
  ...
  "system_operator_product_type_history.replaced_by":
    "The identity that replaced the resource.",
  "service_provider_product_application.id": "Unique surrogate identifier.",
  ...
  "service_provider_product_application_comment_history.replaced_by":
    "The identity that replaced the comment.",
  "service_provider_product_suspension.id": "Unique surrogate identifier.",
