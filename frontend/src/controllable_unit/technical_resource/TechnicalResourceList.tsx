        ...
        <SimpleTable
          ...
          empty={
            <div className="flex flex-col gap-2 py-4">
              ...
              <BodyText>
                A technical resource represents a physical device or asset (such
                as a battery, generator, or flexible load) that provides the
                actual controllable capacity.
              </BodyText>
              <BodyText>
                To set the controllable unit as active, at least one technical
