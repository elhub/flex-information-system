        ...
        <Card className="max-w-3xl">
          <CardContent>
            <div className="flex items-center justify-between gap-4">
              ...
              <Button
                as={Link}
                to={`/controllable_unit/lookup/create?accounting_point_id=${accounting_point.id}&end_user_id=${end_user.id}&accounting_point_business_id=${accounting_point.business_id}`}
                variant="primary"
              >
                Create new unit
              </Button>
